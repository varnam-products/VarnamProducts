            ...
            <div ref={imgRef} className="why-promise-image">
              <picture>
                ...
                <img
                  ...
                  alt="Varnam Naturals — natural, organic ingredients"
                  loading="lazy"
...
function TrustCertifications() {
  ...
  const TRUST_ITEMS = [
    ...
    },
    {
      badge: <IconPlane />,
      title: 'Global Export',
      body: 'Certified and seamless international shipping, carrying Varnam Naturals across the globe.',
    },
  ]
...
function buildOrganizationJsonLd(settings) {
  const org = {
    ...
    description: 'Varnam Naturals makes pure, organic, chemical-free cold-pressed oils, handmade soaps and natural supplements.',
  }
  ...
  return (
    <>
      <Seo
        ...
        description="Shop pure organic cold-pressed oils, handmade soaps and natural supplements from Varnam Naturals. FSSAI certified, chemical-free, made in India."
        path="/"
