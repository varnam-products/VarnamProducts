  ...
  return (
    ...
    >
      ...
      <div className="container-main" style={{ position: 'relative', zIndex: 10 }}>
        ...
        {/* Certifications: FSSAI + MSME */}
        <div className="cert-grid">
          <div className="cert-card">
            <div className="cert-icon"><img src={fssaiLogo} alt="FSSAI Certified" /></div>
            <div>
              <p className="cert-title">FSSAI Certified</p>
              <p className="cert-body">Licensed and regularly audited food business, meeting every safety and hygiene standard set by the Food Safety and Standards Authority of India.</p>
            </div>
          </div>
          <div className="cert-card">
            <div className="cert-icon"><img src={msmeLogo} alt="MSME Registered" /></div>
            <div>
              <p className="cert-title">MSME Registered</p>
              <p className="cert-body">Proudly registered under the Ministry of MSME (Udyam), supporting local farmers and Indian manufacturing at every step.</p>
            </div>
          </div>
        </div>

        {/* Delivery & Reach divider */}
        <div style={{ display: 'flex', alignItems: 'center', gap: 14, margin: '44px 0 20px' }}>
        ...
        {/* Coverage: Pan-India + Global Export */}
        <div className="cert-grid">
          <div className="cert-card coverage-card">
            <div className="cert-icon coverage-icon"><IconTruckFast /></div>
            <div>
              <p className="cert-title">Pan-India Coverage</p>
              <p className="cert-body">Prompt and secure delivery to every corner of India.</p>
            </div>
          </div>
          <div className="cert-card coverage-card">
            <div className="cert-icon coverage-icon"><IconPlane /></div>
            <div>
              <p className="cert-title">Global Export</p>
              <p className="cert-body">Certified and seamless international shipping across the globe.</p>
            </div>
          </div>
        </div>
