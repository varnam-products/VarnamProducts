  ...
  return (
    <PageTransition>
      <Seo
        ...
        description={query ? `Search results for "${query}" at Varnam Foods.` : 'Search the Varnam Foods catalog of organic oils, soaps and supplements.'}
        path="/search"
        noindex
      />
      ...
      {/* Responsive grid — stays at 2 columns all the way down to the
         smallest phone widths; card padding/type scale down with it
         (see .product-card rules in index.css) instead of dropping to 1
         column, so users see more than one product per screen. */}
      <style>{`
        ...
        @media (max-width: 420px)  { .search-grid { grid-template-columns: repeat(2,1fr) !important; gap: 8px !important; } }
