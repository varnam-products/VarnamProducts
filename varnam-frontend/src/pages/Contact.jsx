...
/* ── Business Information ────────────────────────────────────────────────
   Payment-gateway KYC/website-liveliness checks (Cashfree etc.) look for
   the legal entity name as plain, crawlable/readable text — a name shown
   only inside the logo image doesn't satisfy that. This section keeps
   "Varnam Foods" as the customer-facing brand everywhere else and states
   the legal entity here explicitly, alongside it. ────────────────────── */
function BusinessInfo() {
  const ref = useReveal('.biz-info-reveal')
  return (
    <section ref={ref} className="home-section" style={{ background: '#fff' }}>
      <div className="container-main" style={{ maxWidth: 640, margin: '0 auto', textAlign: 'center' }}>
        <div className="biz-info-reveal" style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 18, justifyContent: 'center' }}>
          <span style={{ display: 'block', width: 24, height: 1, background: 'rgba(45,106,79,0.3)' }} />
          <span style={{ fontFamily: 'var(--font-body)', fontSize: 10, color: '#2D6A4F', letterSpacing: '0.26em', textTransform: 'uppercase' }}>
            Business Information
          </span>
          <span style={{ display: 'block', width: 24, height: 1, background: 'rgba(45,106,79,0.3)' }} />
        </div>
        <div className="biz-info-reveal" style={{
          display: 'inline-flex', flexDirection: 'column', gap: 8,
          background: '#FDF6EC', border: '1px solid rgba(45,106,79,0.1)', borderRadius: 16,
          padding: '22px 32px',
        }}>
          <p style={{ fontFamily: 'var(--font-body)', fontSize: 14, color: '#5C5548', margin: 0 }}>
            <strong style={{ color: '#26221C', fontWeight: 700 }}>Brand Name:</strong> Varnam Foods
          </p>
          <p style={{ fontFamily: 'var(--font-body)', fontSize: 14, color: '#5C5548', margin: 0 }}>
            <strong style={{ color: '#26221C', fontWeight: 700 }}>Legal Entity:</strong> DHAYANITHI SUNDARRAJAN
          </p>
        </div>
      </div>
    </section>
...
export default function Contact() {
  ...
  const contactJsonLd = [
    {
      ...
      '@type': 'Organization',
      name: 'Varnam Foods',
      legalName: 'DHAYANITHI SUNDARRAJAN',
      url: SITE_URL,
  ...
  return (
    <>
      <Seo
        title="Contact Us"
        description="Get in touch with Varnam Foods — questions about orders, products or wholesale, we're here to help."
        path="/contact"
