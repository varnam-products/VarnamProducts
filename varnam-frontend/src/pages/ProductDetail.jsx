...
export default function ProductDetail() {
  ...
  const {
    _id, name, shortDescription, description, price, discountPrice,
  ...
  // ── SEO ──────────────────────────────────────────────────────────────
  const seoDescription = shortDescription || (description ? description.slice(0, 160) : `Buy ${name} online — pure, organic and FSSAI certified, from Varnam Naturals.`)
  ...
  const productJsonLd = {
    ...
    sku: _id,
    brand: { '@type': 'Brand', name: 'Varnam Naturals' },
