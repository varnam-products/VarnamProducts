...
function B2BHero({ whatsappHref }) {
  ...
  useGSAP(() => {
    ...
    gsap.fromTo('.b2b-hero-image',
      { scale: 0.94, opacity: 0 },
      { scale: 1, opacity: 1, duration: 0.9, ease: 'power3.out', delay: 0.35 })
  }, { scope: ref })
  ...
  return (
    <section ref={ref} style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="container-main b2b-hero-grid" style={{ position: 'relative', zIndex: 10, padding: '88px 0 76px' }}>
        ...
        <div className="b2b-hero-text">
          ...
          <h1 className="b2b-hero-reveal" style={{
            ...
            fontSize: 'clamp(1.9rem,4vw,3rem)', lineHeight: 1.15, margin: '0 0 20px',
          }}>
            Wholesale & Institutional Supply of Varnam Foods Products
          </h1>
          ...
          <div className="b2b-hero-reveal b2b-hero-cta-row" style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: 14 }}>
        ...
        {/* Image column */}
        <div className="b2b-hero-image-wrap">
          <div className="b2b-hero-image" style={{ position: 'relative' }}>
            <div style={{
              position: 'absolute', inset: '-14px', borderRadius: 28,
              background: 'linear-gradient(160deg, rgba(233,184,122,0.35), rgba(45,106,79,0))',
              filter: 'blur(2px)', zIndex: 0,
            }} />
            <img
              src={HERO_IMAGE}
              alt="Varnam Foods organic products arranged and ready for wholesale supply"
              width="700" height="560"
              loading="eager"
              fetchpriority="high"
              style={{
                position: 'relative', zIndex: 1, display: 'block', width: '100%',
                aspectRatio: '5 / 4', objectFit: 'cover', borderRadius: 24,
                border: '1px solid rgba(253,246,236,0.14)',
                boxShadow: '0 30px 70px rgba(0,0,0,0.35)',
              }}
            />
            <div className="b2b-hero-badge" style={{
              position: 'absolute', zIndex: 2, left: 18, bottom: -18,
              display: 'flex', alignItems: 'center', gap: 10,
              background: '#FDF6EC', borderRadius: 14, padding: '12px 16px',
              boxShadow: '0 14px 34px rgba(0,0,0,0.28)', maxWidth: 230,
            }}>
              <span style={{
              ...
              <span style={{ fontFamily: 'var(--font-body)', fontSize: 11.5, fontWeight: 700, color: '#26221C', lineHeight: 1.35 }}>
                FSSAI & MSME<br />Certified Supply
              </span>
            </div>
          </div>
        </div>
...
export default function B2BWholesale() {
  ...
  return (
    <>
      <Seo
        title="B2B & Wholesale"
        description="Partner with Varnam Foods for bulk and wholesale orders of organic cold-pressed oils, soaps and supplements. Attractive margins for retailers, restaurants and distributors."
        path="/b2b-wholesale"
        jsonLd={b2bJsonLd}
      />
