  ...
  return (
    ...
    >
      ...
      <div style={{ position: 'relative', overflow: 'hidden', aspectRatio: '1/1', background: '#FAFAF7' }}>
        ...
        {/* Discount badge */}
        {hasDiscount && (
          <span className="product-card-discount-badge" style={{
      ...
      {/* ── Info area ───────────────────────────────────────────────────── */}
      <div className="product-card-body" style={{ padding: '14px 16px 16px' }}>
        ...
        <div className="product-card-footer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>

          {/* Price — "From ₹X" when variants differ in price, else the flat effective price */}
          <div className="product-card-price-block" style={{ display: 'flex', alignItems: 'baseline', gap: 6, flexShrink: 0 }}>
            {hasRange && (
              <span className="product-card-from" style={{
            ...
            {hasDiscount && (
              <span className="product-card-strike" style={{
