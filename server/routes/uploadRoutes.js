...
router.post('/blog', protect, admin, uploadBlogStorage.single('image'), uploadBlogImage);
router.post('/banner', protect, admin, uploadBannerStorage.single('image'), uploadBannerImage);
router.post('/banner-video', protect, admin, uploadBannerVideoStorage.single('video'), uploadBannerVideo);
