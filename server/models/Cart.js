...
const cartItemSchema = new mongoose.Schema(
  {
    ...
    // Identifies which of the product's variants this line is for (matches the
    // _id Mongoose auto-assigns to each entry in Product.variants). A cart line's
    // real identity is product + variantId — the same product in two different
    // variants (e.g. 500ml vs 1L) must sit as two separate lines.
    variantId: {
      type: mongoose.Schema.Types.ObjectId,
      required: true,
    },
